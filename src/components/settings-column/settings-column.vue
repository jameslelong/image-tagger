    ...
    <div id="tag-container">
      ...
      <ul id="tag-list" class="tree-list">
        <li class="tag-list-item" v-for="tag in tags" v-bind:key="tag.id">
          <!-- Tag Branch Controls -->
          <div
            class="tag-list-item-inner"
            v-bind:class="{ selected: selectedTag.id === tag.id }"
          >
            <button
              class="tag-dropdown-button"
              v-on:click="toggleBranch(tag)"
              v-bind:class="{ active: isBranchEnabled(tag) }"
            >
          ...
          <!-- Nest Selection List -->
          <ul
            class="selection-list tree-list"
            v-bind:class="{ active: isBranchEnabled(tag) }"
          >
            <li
              class="selection-list-item"
              v-for="selection of selectionsOfTag(tag)"
              v-bind:key="selection.id"
              v-on:mouseenter="highlightSelection(selection, true)"
              v-on:mouseleave="highlightSelection(selection, false)"
            >
              ...
              <button
                class="tree-delete"
                v-on:click="deleteSelection(tag, selection)"
              >
                <i class="fas fa-trash fa-xs"></i>
              </button>
            </li>
